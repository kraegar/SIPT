...
setup_changes = { 'None':                ['',
                  ...
                  'Russia':               ['On each board, add one beast and one explorer to the highest-numbered land without towns/cities.\n',
                                           ...
                                           '',
                                           '',
                                           'Put an unused Stage II Invader card under the top 3 fear cards, and an unused Stage III Card under the top 7 fear cards.\n',
                                           ''],
                  'Habsburg':             ['',
...
fearscreen_rules = {
    ...
    'Russia': [              
                            ...
                            '',
                            '',
                            'When an invader card is revealed, immediately place it in the build space (face up).\n',
                            ''],
    'Habsburg': [            
                            '',
                            '',
